...
$client->setClientId("211713370324-hkiivnsih1tfvdm9hdfouo3eqdpkvhm3.apps.googleusercontent.com");
// Enter your Client Secrect
$client->setClientSecret("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");
// Enter the Redirect URL
$client->setRedirectUri("http://localhost/login-with-google/login.php");
